    ...
    (function() {
      ...
      z("Promise", function(a) {
        ...
        b.prototype.j = function() {
          ...
          var h = this, k = false;
          return { resolve: f(this.H), reject: f(this.l) };
        };
      ...
      var Ha = {};
      var Ia = "function" === typeof Uint8Array.prototype.slice, I = 0, K = 0;
      function Ja(a) {
        var b = 0 > a;
        a = Math.abs(a);
        var c = a >>> 0;
      ...
      function La(a) {
        ...
        if (0 === a) 0 < 1 / a ? I = K = 0 : (K = 0, I = 2147483648);
          ...
          a = b ? -a : a;
          if (34028234663852886e22 < a) K = 0, I = (b | 2139095040) >>> 0;
          else if (11754943508222875e-54 > a) a = Math.round(a / Math.pow(2, -149)), K = 0, I = (b | a) >>> 0;
          else {
      ...
      var Ua = void 0, Va, Wa = "undefined" !== typeof TextDecoder, Xa, Ya = "undefined" !== typeof TextEncoder;
      var Za;
      function $a(a) {
      ...
      ;
      function db(a) {
        if ("string" === typeof a) return { buffer: Ba(a), A: false };
        if (Array.isArray(a)) return { buffer: new Uint8Array(a), A: false };
        if (a.constructor === Uint8Array) return { buffer: a, A: false };
        if (a.constructor === ArrayBuffer) return { buffer: new Uint8Array(a), A: false };
        if (a.constructor === ab) return { buffer: cb(a) || Ga(), A: true };
        if (a instanceof Uint8Array) return { buffer: new Uint8Array(a.buffer, a.byteOffset, a.byteLength), A: false };
      ...
      eb.prototype.s = function() {
        var a = this.h, b = this.g, c = a[b], d = a[b + 1];
        var e = a[b + 2];
        a = a[b + 3];
        N(this, this.g + 4);
      ...
      ob.prototype.setOptions = function(a) {
        a = void 0 === a ? {} : a;
        this.da = void 0 === a.da ? false : a.da;
      };
        ...
        switch (a.h) {
          case 0:
            if (0 != a.h) qb(a);
              ...
              a = a.g;
              for (var b = a.g, c = b + 10, d = a.h; b < c; ) if (0 === (d[b++] & 128)) {
                N(a, b);
                break a;
              }
              throw Ra();
      ...
      function rb(a, b, c) {
        var d = a.g.i, e = a.g.j(), g = a.g.g + e, f = g - d;
      ...
      function Bb(a, b) {
        Object.isFrozen(a) || (P ? a[P] |= b : void 0 !== a.D ? a.D |= b : Object.defineProperties(a, { D: { value: b, configurable: true, writable: true, enumerable: false } }));
      }
      function Cb(a) {
        var b;
        P ? b = a[P] : b = a.D;
      ...
      function Db(a) {
        return Array.isArray(a) ? !!(Cb(a) & 2) : false;
      }
      function Eb(a) {
      ...
      function Tb(a) {
        var b = Number, c = U(a, 3, false);
        if (c.length && !(Cb(c) & 4)) {
          Object.isFrozen(c) && (c = Q(c.slice()), T(a, 3, c, void 0, true));
      ...
      function Zb(a, b, c) {
        ...
        if (c) for (b = 0; b < c.length; b++) if (a = c[b], a < this.h) a += this.C, (d = this.o[a]) ? Array.isArray(d) && Q(d) : this.o[a] = Hb;
        else {
          d = Sb(this);
          var e = d[a];
      ...
      function cc(a, b, c) {
        if (c) {
          ...
          for (e in c) {
            var g = c[e], f = g.ra;
            f || (d.I = g.xa || g.oa.W, g.ja ? (d.aa = dc(g.ja), f = /* @__PURE__ */ function(h) {
              return function(k, l, m) {
                return h.I(k, l, m, h.aa);
              };
            }(d)) : g.ka ? (d.Z = ec(g.ea.O, g.ka), f = /* @__PURE__ */ function(h) {
              return function(k, l, m) {
                return h.I(k, l, m, h.Z);
              };
            }(d)) : f = d.I, g.ra = f);
            f(b, a, g.ea);
            d = { I: d.I, aa: d.aa, Z: d.Z };
          }
        }
        yb(b, a);
      }
      ...
      function kc(a) {
        var b = a.ja;
        if (b) return hc(b);
        if (b = a.wa) return gc(a.ea.O, b, a.ka);
      }
      function lc(a) {
        var b = kc(a), c = a.ea, d = a.oa.U;
      ...
      function zc(a, b, c, d, e) {
        var g = c.U, f = hc(d), h = ic(d).O;
        a[b] = function(k, l, m) {
          return g(k, l, m, h, f, e);
        };
      }
      function Ac(a, b, c, d, e, g, f) {
        var h = c.U, k = gc(d, e, g);
        a[b] = function(l, m, r) {
      ...
      function Bc(a, b) {
        ...
        try {
          ...
          b = a.g, b.h = null, b.u = false, b.l = 0, b.i = 0, b.g = 0, b.S = false, a.j = -1, a.h = -1, 100 > tb.length && tb.push(a);
        }
      }
      function sc(a, b, c) {
      ...
      var Y = W(function(a, b, c) {
        ...
        b = U(b, c);
        if (null != b && b.length) for (O(a, c, 2), lb(a.g, 4 * b.length), c = 0; c < b.length; c++) {
          var d = a.g;
          La(b[c]);
          nb(d);
        }
        ...
        var d = a.g, e = 0, g = a = 0, f = d.h, h = d.g;
        do {
          var k = f[h++];
          e |= (k & 127) << g;
          g += 7;
        ...
        b = S(b, c);
        null != b && null != b && (O(a, c, 0), mb(a.g, b));
      }), Ic = W(function(a, b, c) {
        ...
        if (Wa) {
          var g = a, f;
          (f = Va) || (f = Va = new TextDecoder("utf-8", { fatal: true }));
          a = e + d;
          ...
          try {
            ...
            if (void 0 === Ua) {
              ...
              try {
                f.decode(new Uint8Array([97])), Ua = true;
              } catch (p) {
                Ua = false;
              }
            }
          ...
          d = h + d;
          e = [];
          for (var k = null, l, m; h < d; ) l = a[h++], 128 > l ? e.push(l) : 224 > l ? h >= d ? M() : (m = a[h++], 194 > l || 128 !== (m & 192) ? (h--, M()) : e.push((l & 31) << 6 | m & 63)) : 240 > l ? h >= d - 1 ? M() : (m = a[h++], 128 !== (m & 192) || 224 === l && 160 > m || 237 === l && 160 <= m || 128 !== ((g = a[h++]) & 192) ? (h--, M()) : e.push((l & 15) << 12 | (m & 63) << 6 | g & 63)) : 244 >= l ? h >= d - 2 ? M() : (m = a[h++], 128 !== (m & 192) || 0 !== (l << 28) + (m - 144) >> 30 || 128 !== ((g = a[h++]) & 192) || 128 !== ((f = a[h++]) & 192) ? (h--, M()) : (l = (l & 7) << 18 | (m & 63) << 12 | (g & 63) << 6 | f & 63, l -= 65536, e.push((l >> 10 & 1023) + 55296, (l & 1023) + 56320))) : M(), 8192 <= e.length && (k = Ta(k, e), e.length = 0);
          h = Ta(k, e);
        }
        T(b, c, h);
        return true;
        ...
        b.m || (b.m = {});
        var g = b.m[c];
        g ? (d = g.R(zb), d !== g && (T(b, c, d.o), b.m[c] = d), b = d) : (g = S(b, c), d = Lb(g, d, true).R(zb), g !== d.o && T(b, c, d.o), b = b.m[c] = d);
        rb(a, b, e);
        return true;
      }, function(a, b, c, d, e) {
        b = Vb(b, d, c);
        null != b && (c = wb(a, c), e(b, a), xb(a, c));
      ...
      function Nc(a, b, c, d, e, g) {
        if (a = a.m && a.m[c]) if (Array.isArray(a)) {
          e = g.ca ? Q(a.slice()) : a;
          Ib(b);
          if (null != e) {
            g = Q([]);
      ...
      Z.prototype.R = function(a) {
        ...
        if (R(this)) {
          ...
          for (var d = this.o, e = 0; e < d.length; e++) {
            var g = d[e];
            if (e === d.length - 1 && Gb(g)) for (h in g) {
              var f = +h;
      ...
      var Qc = [3], Rc = [Pc, 1, Hc, 2, Hc, 3, Fc, 4, Mc];
      function Sc(a) {
        Z.call(this, a);
      }
      E(Sc, Z);
      ...
      var ed = [3, 4], fd = [dd, 1, Mc, 2, Mc, 3, Ec, 4, Lc];
      function gd(a) {
        Z.call(this, a);
      }
      E(gd, Z);
      ...
      function jd(a) {
        return Xb(a, Sc, 1).map(function(b) {
          return { index: Ub(b, 1, 0), qa: V(b, 2), label: null != S(b, 3) ? Ub(b, 3, "") : void 0, displayName: null != S(b, 4) ? Ub(b, 4, "") : void 0 };
        });
      }
      ;
      function kd(a) {
        return { x: V(a, 1), y: V(a, 2), z: V(a, 3), visibility: null != S(a, 4) ? V(a, 4) : void 0 };
      }
      ;
      function ld(a, b) {
        this.h = a;
      ...
      function nd(a, b) {
        ...
        if (void 0 === a.s) {
          ...
          a.j = { N: c.getAttribLocation(d, "aVertex"), M: c.getAttribLocation(d, "aTex"), ya: e };
          a.v = c.createBuffer();
          c.bindBuffer(c.ARRAY_BUFFER, a.v);
          c.enableVertexAttribArray(a.j.N);
          c.vertexAttribPointer(a.j.N, 2, c.FLOAT, false, 0, 0);
        ...
        c.bindBuffer(c.ARRAY_BUFFER, a.v);
        c.vertexAttribPointer(d.N, 2, c.FLOAT, false, 0, 0);
      ...
      ;
      var pd = new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 9, 1, 7, 0, 65, 0, 253, 15, 26, 11]);
      function qd(a, b) {
        return b + a;
      }
      function rd(a, b) {
      ...
      function td() {
        return G(function(a) {
          switch (a.g) {
            case 1:
              return a.s = 2, F(a, WebAssembly.instantiate(pd), 4);
            case 4:
              a.g = 3;
              a.s = 0;
              break;
            case 2:
              return a.s = 0, a.j = null, a.return(false);
            case 3:
      ...
      function ud(a) {
        ...
        this.s = {};
        this.v = {};
        this.L = this.u = this.ha = true;
        this.H = Promise.resolve();
        this.ga = "";
        this.G = {};
        this.locateFile = a && a.locateFile || qd;
      ...
      function vd(a) {
        ...
        return G(function(p) {
          switch (p.g) {
            ...
            case 2:
              c = p.h;
              if ("object" === typeof window) return rd("createMediapipeSolutionsWasm", { locateFile: a.locateFile }), rd("createMediapipeSolutionsPackedAssets", { locateFile: a.locateFile }), f = b.filter(function(n) {
                ...
                return void 0 === n.simd || n.simd && c || !n.simd && !c ? sd(a.locateFile(n.url, a.ia)) : Promise.resolve();
              })).then(function() {
                var n, q, t;
                return G(function(x) {
            ...
            case 4:
              a.i = new a.h.SolutionWasm(), a.ha = false, p.g = 0;
          }
        });
      }
      function xd(a) {
        ...
        return G(function(l) {
          if (1 == l.g) {
            ...
            a.ga = a.g.graph.url;
            return F(l, wd(a, a.g.graph.url), 3);
          }
          2 != l.g && (b = l.h, a.i.loadGraph(b));
          c = A(Object.keys(a.G));
          for (d = c.next(); !d.done; d = c.next()) e = d.value, a.i.overrideFile(e, a.G[e]);
          a.G = {};
          if (a.g.listeners) for (g = A(a.g.listeners), f = g.next(); !f.done; f = g.next()) h = f.value, yd(a, h);
          k = a.j;
          a.j = {};
          a.setOptions(k);
          l.g = 0;
      ...
      v.setOptions = function(a, b) {
        ...
        if (b = b || this.g.options) {
          for (var d = [], e = [], g = {}, f = A(Object.keys(a)), h = f.next(); !h.done; g = { X: g.X, Y: g.Y }, h = f.next()) if (h = h.value, !(h in this.j && this.j[h] === a[h])) {
            this.j[h] = a[h];
            var k = b[h];
          ...
          if (0 !== d.length || 0 !== e.length) this.u = true, this.F = (void 0 === this.F ? [] : this.F).concat(e), this.B = (void 0 === this.B ? [] : this.B).concat(d);
        }
      };
      function zd(a) {
        var b, c, d, e, g, f, h;
      ...
      v.initialize = function() {
        var a = this;
        return G(function(b) {
          return 1 == b.g ? F(b, vd(a), 2) : 3 != b.g ? F(b, xd(a), 3) : F(b, zd(a), 0);
        });
      };
      function wd(a, b) {
        var c, d;
              ...
              for (f = g.next(); !f.done; f = g.next()) if (h = f.value, k = c.g.inputs[h]) {
                a: {
                  ...
                  switch (k.type) {
                    case "video":
                      var q = c.s[k.stream];
                      q || (q = new ld(c.h, c.J), c.s[k.stream] = q);
                    ...
                    case "detections":
                      q = c.s[k.stream];
                      q || (q = new od(c.h), c.s[k.stream] = q);
                      q.data || (q.data = new q.g.DetectionListData());
                      q.data.reset(n.length);
                      for (x = 0; x < n.length; ++x) {
                        t = n[x];
                        var w = q.data, B = w.setBoundingBox, L = x;
                        var J = t.la;
                        var u = new bd();
                        T(u, 1, J.sa);
                        T(u, 2, J.ta);
                        ...
                        J = Cc(u, cd);
                        B.call(w, L, J);
                        if (t.fa) for (w = 0; w < t.fa.length; ++w) {
                          u = t.fa[w];
                          B = q.data;
                          L = B.addNormalizedLandmark;
                          J = x;
                          ...
                          T(C, 2, u.y);
                          T(C, 3, u.z);
                          u.visibility && T(C, 4, u.visibility);
                          u = Cc(
                            C,
                            Yc
                          );
                        ...
                        if (t.ba) for (w = 0; w < t.ba.length; ++w) B = q.data, L = B.addClassification, J = x, u = t.ba[w], C = new Sc(), T(C, 2, u.qa), u.index && T(C, 1, u.index), u.label && T(C, 3, u.label), u.displayName && T(C, 4, u.displayName), u = Cc(C, Tc), L.call(B, J, u);
                      }
                      q = q.data;
                      break a;
                    default:
        ...
        return G(function(w) {
          switch (w.g) {
            ...
            case 2:
              ...
              m = f.value;
              r = c[m];
              if ("string" === typeof r) return t = d, x = m, F(w, Bd(a, m, b[r]), 14);
              p = b[r.stream];
              if ("detection_list" === r.type) {
                if (p) {
                  var B = p.getRectList();
                  for (var L = p.getLandmarksList(), J = p.getClassificationsList(), u = [], C = 0; C < B.size(); ++C) {
                    var X = Bc(B.get(C), cd);
                    X = { la: { sa: V(X, 1), ta: V(X, 2), height: V(X, 3), width: V(X, 4), rotation: V(X, 5, 0), pa: Ub(X, 6, 0) }, fa: Xb(Bc(L.get(C), ad), Xc, 1).map(kd), ba: jd(Bc(J.get(C), Wc)) };
                    u.push(X);
                  }
                  B = u;
                } else B = [];
              ...
              if ("proto_list" === r.type) {
                if (p) {
                  B = Array(p.size());
                  for (L = 0; L < p.size(); L++) B[L] = p.get(L);
                  p.delete();
                } else B = [];
                d[m] = B;
                w.g = 7;
              ...
              n = a.v[m];
              n || (n = new ld(a.h, a.J), a.v[m] = n);
              return F(w, md(n, p, a.L), 13);
            case 13:
              q = w.h, d[m] = q;
            case 7:
      ...
      function Bd(a, b, c) {
        var d;
        return G(function(e) {
          return "number" === typeof c || c instanceof Uint8Array || c instanceof a.h.Uint8BlobList ? e.return(c) : c instanceof a.h.Texture2dDataOut ? (d = a.v[b], d || (d = new ld(a.h, a.J), a.v[b] = d), e.return(md(d, c, a.L))) : e.return(void 0);
        });
      }
      function yd(a, b) {
        for (var c = b.name || "$", d = [].concat(D(b.wants)), e = new a.h.StringList(), g = A(b.wants), f = g.next(); !f.done; f = g.next()) e.push_back(f.value);
        g = a.h.PacketListener.implement({ onResults: function(h) {
          for (var k = {}, l = 0; l < b.wants.length; ++l) k[d[l]] = h.get(l);
          var m = a.listeners[c];
          m && (a.H = Ad(a, k, b.outs).then(function(r) {
            r = m(r);
      ...
      H("Solution", ud);
      H("OptionType", { BOOL: 0, NUMBER: 1, ua: 2, 0: "BOOL", 1: "NUMBER", 2: "STRING" });
      function Cd(a) {
        a = Bc(a, hd);
        var b = a.getMesh();
        if (!b) return a;
      ...
      ;
      var Dd = { files: [{ url: "face_mesh_solution_packed_assets_loader.js" }, { simd: true, url: "face_mesh_solution_simd_wasm_bin.js" }, { simd: false, url: "face_mesh_solution_wasm_bin.js" }], graph: { url: "face_mesh.binarypb" }, listeners: [{ wants: ["multi_face_geometry", "image_transformed", "multi_face_landmarks"], outs: { image: "image_transformed", multiFaceGeometry: { type: "proto_list", stream: "multi_face_geometry", transform: function(a) {
        return a.map(Cd);
        ...
        enableFaceGeometry: { type: 0, graphOptionXref: {
        ...
        maxNumFaces: { type: 1, graphOptionXref: { calculatorType: "ConstantSidePacketCalculator", calculatorName: "ConstantSidePacketCalculatorNumFaces", fieldName: "int_value" } },
        refineLandmarks: { type: 0, graphOptionXref: { calculatorType: "ConstantSidePacketCalculator", calculatorName: "ConstantSidePacketCalculatorRefineLandmarks", fieldName: "bool_value" } },
        minDetectionConfidence: { type: 1, graphOptionXref: { calculatorType: "TensorsToDetectionsCalculator", calculatorName: "facelandmarkfrontgpu__facedetectionshortrangegpu__facedetectionshortrange__facedetection__TensorsToDetectionsCalculator", fieldName: "min_score_thresh" } },
        ...
        cameraNear: { type: 1, graphOptionXref: {
      ...
      var Ed = [[61, 146], [146, 91], [91, 181], [181, 84], [84, 17], [17, 314], [314, 405], [405, 321], [321, 375], [375, 291], [61, 185], [185, 40], [40, 39], [39, 37], [37, 0], [0, 267], [267, 269], [269, 270], [270, 409], [409, 291], [78, 95], [95, 88], [88, 178], [178, 87], [87, 14], [14, 317], [317, 402], [402, 318], [318, 324], [324, 308], [78, 191], [191, 80], [80, 81], [81, 82], [82, 13], [13, 312], [312, 311], [311, 310], [310, 415], [415, 308]], Fd = [[263, 249], [249, 390], [390, 373], [373, 374], [374, 380], [380, 381], [381, 382], [382, 362], [263, 466], [466, 388], [388, 387], [387, 386], [
        386,
        385
      ], [385, 384], [384, 398], [398, 362]], Gd = [[276, 283], [283, 282], [282, 295], [295, 285], [300, 293], [293, 334], [334, 296], [296, 336]], Hd = [[33, 7], [7, 163], [163, 144], [144, 145], [145, 153], [153, 154], [154, 155], [155, 133], [33, 246], [246, 161], [161, 160], [160, 159], [159, 158], [158, 157], [157, 173], [173, 133]], Id = [[46, 53], [53, 52], [52, 65], [65, 55], [70, 63], [63, 105], [105, 66], [66, 107]], Jd = [
        [10, 338],
        [338, 297],
        [297, 332],
        [332, 284],
        ...
        [67, 109],
        [109, 10]
      ], Kd = [].concat(D(Ed), D(Fd), D(Gd), D(Hd), D(Id), D(Jd));
      function Ld(a) {
        a = a || {};
        this.g = new ud(Object.assign({}, Dd, a));
      }
      v = Ld.prototype;
      v.close = function() {
        this.g.close();
      ...
      H("FaceMesh", Ld);
      H("FACEMESH_LIPS", Ed);
      H("FACEMESH_LEFT_EYE", Fd);
      H("FACEMESH_LEFT_EYEBROW", Gd);
      H("FACEMESH_LEFT_IRIS", [[474, 475], [475, 476], [476, 477], [477, 474]]);
      H("FACEMESH_RIGHT_EYE", Hd);
      H("FACEMESH_RIGHT_EYEBROW", Id);
      H("FACEMESH_RIGHT_IRIS", [[469, 470], [470, 471], [471, 472], [472, 469]]);
      H("FACEMESH_FACE_OVAL", Jd);
      H("FACEMESH_CONTOURS", Kd);
